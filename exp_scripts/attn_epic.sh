...
resume_path=' --resume_path results/epic_btsnet26multistep0.01_M4_O2_TC__save_250.pth '
#' --resume_path results/ucf101_btsnet26multistep0.1_M4_O2_TC__save_200.pth '

annotation_path='/raid/video_data/epic/slowfast_frames/annotation/epic_noun.json'
