...
pre_path=' '  #'--pretrain_path results/mit_sknet50_M2__save_6.pth --n_pretrain_classes 339'
resume_path=' --resume_path results/hollywood2_sknet3101_M4__save_200.pth '
root_path='./'
annotation_path='./'
