...
class SKConv(nn.Module):
    # features = mid_planes
    def __init__(self, mid_planes, ops_type='O2', fuse_layer='TC', M=2, G=32, r=16, stride=1 ,L=32):
...
class SKUnit(nn.Module):
    ...
    def __init__(self, in_planes, planes, cardinality, ops_type='O2', fuse_layer='TC', M=2, G=32, r=16, stride=1, L=32):
        ...
        # conv2
        self.conv2_sk = SKConv(mid_planes, ops_type=ops_type, fuse_layer=fuse_layer, M=M, G=G, r=r, stride=stride, L=L)
