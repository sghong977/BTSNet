...
def main_worker(index, opt):
    ...
    info = opt.dataset + '_class' + str(opt.n_classes) + '_kfold' + str(opt.splitNum) + '_' +opt.model + str(opt.model_depth)+ '_card' + str(opt.resnext_cardinality) + opt.lr_scheduler + str(opt.learning_rate) + '_M' + str(opt.M) + '_' + opt.ops_type + '_' + opt.fuse_layer + '_'    ###
    print(info)
